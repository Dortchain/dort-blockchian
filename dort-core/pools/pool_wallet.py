...
from Dort.pools.pool_config import PoolWalletConfig, load_pool_config, update_pool_config
from Dort.pools.pool_wallet_info import (
    PoolWalletInfo,
    PoolSingletonState,
    PoolState,
    FARMING_TO_POOL,
...
from Dort.protocols.pool_protocol import POOL_PROTOCOL_VERSION

from Dort.types.announcement import Announcement
from Dort.types.blockchain_format.coin import Coin
from Dort.types.blockchain_format.sized_bytes import bytes32
from Dort.types.blockchain_format.program import Program, SerializedProgram
from Dort.types.coin_record import CoinRecord
from Dort.types.coin_solution import CoinSolution
from Dort.types.spend_bundle import SpendBundle

from Dort.pools.pool_puzzles import (
...
class PoolWallet:
    ...
    async def create_new_pool_wallet_transaction(
        ...
        the same pooling puzzle. This puzzle is a `Dort singleton` that is
