...
from Dort.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from Dort.harvester.harvester import Harvester
from Dort.plotting.plot_tools import PlotInfo, parse_plot_info
from Dort.protocols import harvester_protocol
from Dort.protocols.farmer_protocol import FarmingInfo
from Dort.protocols.harvester_protocol import Plot
from Dort.protocols.protocol_message_types import ProtocolMessageTypes
from Dort.server.outbound_message import make_msg
...
from Dort.util.api_decorators import api_request, peer_required
from Dort.util.ints import uint8, uint32, uint64
from Dort.wallet.derive_keys import master_sk_to_local_sk
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSDortConnection
    ):
        """
