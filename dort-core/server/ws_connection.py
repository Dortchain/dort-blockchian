...
from Dort.cmds.init_funcs import Dort_full_version_str
from Dort.protocols.protocol_message_types import ProtocolMessageTypes
from Dort.protocols.shared_protocol import Capability, Handshake
from Dort.server.outbound_message import Message, NodeType, make_msg
from Dort.server.rate_limits import RateLimiter
...
from Dort.util.ints import uint8, uint16

# Each message is prepended with LENGTH_BYTES bytes specifying the length
from Dort.util.network import class_for_type, is_localhost

# Max size 2^(8*4) which is around 4GiB
LENGTH_BYTES: int = 4


class WSDortConnection:
    """
