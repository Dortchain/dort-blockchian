...
from Dortvdf import create_discriminant

from Dort.consensus.constants import ConsensusConstants
from Dort.consensus.pot_iterations import calculate_sp_iters, is_overflow_block
...
from Dort.timelord.timelord_state import LastState
from Dort.timelord.types import Chain, IterationType, StateType
from Dort.types.blockchain_format.classgroup import ClassgroupElement
from Dort.types.blockchain_format.reward_chain_block import RewardChainBlock
from Dort.types.blockchain_format.sized_bytes import bytes32
from Dort.types.blockchain_format.slots import (
...
class Timelord:
    def __init__(self, root_path, config: Dict, constants: ConsensusConstants):
        ...
        self.server: Optional[DortServer] = None
