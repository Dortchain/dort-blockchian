...
from Dort.farmer.farmer import Farmer
from Dort.protocols import farmer_protocol, harvester_protocol
from Dort.protocols.harvester_protocol import PoolDifficulty
...
class FarmerAPI:
    ...
    async def new_proof_of_space(
        self, new_proof_of_space: harvester_protocol.NewProofOfSpace, peer: ws.WSDortConnection
    ):
        """
